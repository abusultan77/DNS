...
export const Acceptbid = () => {
    return (
        <>
            <section className='main-acceptbid'>
                                ...
                                <div className='col-xl-6 col-md-6 col-sm-12 p-0'>
                                    <div className='bittingpills'>
                                        ...
                                        <div className='bid-tabs'>
                                            <nav>
                                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                    ...
                                                    <a class="nav-link" id="nav-Bids History-tab" data-toggle="tab" href="#nav-Bids History" role="tab" aria-controls="nav-Bids History" aria-selected="false">Bids History</a>
                                        ...
                                        <div className='lastcardbtn position-sticky'>
                                            ...
                                            <button className='btnbtnbid' data-target="#bidmodal" data-toggle="modal">Accept Bid</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-dialog ">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title text-center" id="exampleModalLabel">Accept Bid</h3>

                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true"><img src='\adress\g3763.png' className='img-fluid' /></span>
                                </button>
                            </div>
                            <div class="modal-body">

                                <p className=''>You are about to accept bid by<span >Leslie Alexander on fireape.tomi</span> </p>
                                <div className='text-modalbid'>
                                    <h4 className='bidhead'>Bid offered</h4>
                                    <div className='innertext-modalbid'>
                                        <img src='\adress\Group.svg' alt='img' className='img-fluid'></img>
                                        <h3 className='head ml-2'>1.122 ETH</h3>
                                    </div>
                                </div>
