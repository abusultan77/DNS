          ...
          <div class="row">
            <div class="col-sm-11 col-12 m-auto p-0">
                ...
                <div className="col-xl-9 col-12">
                  <div className="input-field">
                    <img
                      ...
                      alt="img"
                      className="img-field search-img"
                    />
                  ...
                  <div className="right-items">
                    <div class="btns">
                      <div class="dropdown drop1">
                        <button
                          class="btn dropdown-toggle dropmenu1"
                          type="button"
                        ...
                        <button class="btn-1">
                          <img
                            src="assets\vuesax\linear\vuesax\linear\refresh.svg"
                            alt="img"
                          />
                        </button>
                      </div>
              ...
              <div class="btn-div mt-5">
                <button class="btn-2 load-more">Loading more</button>
              </div>
            </div>
          </div>
        </div>
