                                ...
                                <div className='col-xl-6 col-md-6 col-sm-12 p-0'>
                                    <div className='bittingpills'>
                                        ...
                                        <div className='lastcardbtn position-sticky'>
                                            ...
                                            <button className='btnbtnbid' data-toggle="modal" data-target="#placebid" >Place a Bid</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-dialog ">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title text-center" id="exampleModalLabel">Place a Bid</h3>
                            ...
                            <div class="modal-body">
                                ...
                                <p className=''>You are about to Place a Bid on<span >fireape.tomi</span> by <span> Leslie Alexander </span> </p>
                                <div className="input-field">
                                    <div className="upper-text">
                                        <p>You Bid</p>
                                        <p>Min. Bid: <span> 1.20 ETH </span></p>
                                    </div>
